...
butler_html_path = "/Users/sebastianlilliecreutz/Downloads/Home - Golfyr_files/butler.html"

url = f"file://{butler_html_path}"

layouts = [
    ("butler_desktop_full.png", 1440, 5000),
    ("butler_mobile_full.png", 390, 6500)
]

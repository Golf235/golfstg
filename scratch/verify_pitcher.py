...
pitcher_html_path = "/Users/sebastianlilliecreutz/Downloads/Home - Golfyr_files/pitcher.html"

url = f"file://{pitcher_html_path}"

layouts = [
    ("pitcher_desktop_full.png", 1440, 5000),
    ("pitcher_mobile_full.png", 390, 6500)
]

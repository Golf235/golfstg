...
class MakerDetailExtractor(HTMLParser):
    def __init__(self):
        super().__init__()
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if 'where-headline' in classes or ('where' in classes and tag == 'h2'):
            ...
            # Check if parent is a list or inside where-wrapper
    ...
    def current_is_in_why_slide(self):
        # Allow capturing title/content in slides
        return True
...
def run_local_extraction(filepath, lang):
    ...
    for img in sorted(parser.images):
        if 'maker' in img.lower() or 'why' in img.lower() or 'spec' in img.lower():
            print(f"  {img}")

run_local_extraction("/Users/sebastianlilliecreutz/Downloads/Home - Golfyr_files/scratch/maker_en.html", "ENGLISH")
run_local_extraction("/Users/sebastianlilliecreutz/Downloads/Home - Golfyr_files/scratch/maker_de.html", "GERMAN")
